...
class Cadastro
{
  public function saida(): string
  {
    $saida = '<div class="flex flex-row w-full justify-between mt-6 space-x-4">
                   ...
                   <a href="index.php?route=listarSenhas" class="text-blue-700 bg-blue-50 font-semibold px-4 py-2 rounded-md hover:bg-blue-100 transition">Ver Senhas</a>
               </div>';

    $saida .= '
		<p class="text-lg font-semibold mb-4">Cadastrar uma nova Senha</p>
		<form action="index.php?route=novaSenha" method="POST" class="space-y-4">
