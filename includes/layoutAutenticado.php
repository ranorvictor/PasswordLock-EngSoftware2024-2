...
<body class="flex flex-col min-h-screen bg-neutral-white">
    <header class="default-x-spacing flex flex-row justify-between my-[54px]">
        ...
        <div class="relative max-w-md w-full">
            ...
            <div class="modal-usuario hidden absolute right-0 bg-neutral-white border-[1px] border-neutral-gray p-[18px] rounded-[10px] shadow-[0px] flex flex-col gap-[9px] z-2">
